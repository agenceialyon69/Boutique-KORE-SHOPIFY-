...
- [x] **Paiement Shopify Payments ACTIVÉ** (Shop Pay, Visa, Mastercard) — versements
  vers compte Boursorama EUR **d'Aïcha** (confirmé)
- [x] **Pages légales créées + liées au footer** (mentions, CGV, confidentialité, livraison,
  à propos, contact, FAQ) — vérifiées, liens OK
...
2. [ ] **Images** — remplacer celles à filigrane (Lipswag, « 10 Colour »)
3. [ ] **Avis** — installer Judge.me, supprimer les faux placeholders
4. [ ] **Pages légales + Contact** — coller + lier au footer
5. [ ] **Descriptions produits** — coller les versions réécrites
6. [ ] **Paiement express + domaine perso**
