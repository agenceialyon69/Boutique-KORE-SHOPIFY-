...
def bar_overlay(text_lines, top=True, path="/tmp/final/o.png"):
...
bar_overlay([("La tenue complète",56),("qui va du sport au quotidien",44)], top=True, path="/tmp/final/o1.png")
bar_overlay([("Coordonné, confortable,",44),("prête en 10 secondes",44)], top=False, path="/tmp/final/o2.png")
bar_overlay([("Disponible en plusieurs coloris",50)], top=True, path="/tmp/final/o3.png")
bar_overlay([("Ensemble 3 pièces",48),("brassière + legging + veste",40)], top=False, path="/tmp/final/o4.png")
...
overlay("/tmp/final/s1.mp4","/tmp/final/o1.png","/tmp/final/f1.mp4")
overlay("/tmp/final/s2.mp4","/tmp/final/o2.png","/tmp/final/f2.mp4")
overlay("/tmp/final/s3.mp4","/tmp/final/o3.png","/tmp/final/f3.mp4")
overlay("/tmp/final/s4.mp4","/tmp/final/o4.png","/tmp/final/f4.mp4")
...
cv.save("/tmp/final/cta.jpg",quality=92)
subprocess.run([exe,"-y","-loop","1","-i","/tmp/final/cta.jpg","-vf","scale=1080:1920,format=yuv420p",
                 "-frames:v","96","-c:v","libx264","-pix_fmt","yuv420p","-r","30","/tmp/final/f5.mp4"],
                capture_output=True)

clips=["/tmp/final/f1.mp4","/tmp/final/f2.mp4","/tmp/final/f3.mp4","/tmp/final/f4.mp4","/tmp/final/f5.mp4"]
open("/tmp/final/list.txt","w").write("".join(f"file '{c}'\n" for c in clips))
subprocess.run([exe,"-y","-f","concat","-safe","0","-i","/tmp/final/list.txt",
                 "-c:v","libx264","-pix_fmt","yuv420p","-movflags","+faststart",
                 "brand/KORE-pub-finale.mp4"], capture_output=True)
p=subprocess.run([exe,"-i","brand/KORE-pub-finale.mp4"],capture_output=True,text=True)
